...
bool stringIsPartiallyMatching(String substring, char* string){
...
bool findTick(void* data0, void* data1, void* data2){
    ...
    if(wasKeyTyped){
        findActionFromBeggining(data0, data1, (void*)(&panel->buffer));
    }
}

bool quickOpenFileTick(void* data0, void* data1, void* data2){
    Panel* panel = (Panel*)data0;
    KeyboardManager* keyboardManager = (KeyboardManager*)data2;
